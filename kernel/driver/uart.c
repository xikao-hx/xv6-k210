...
// done from a transfer stopped mid-switch doesn't re-raise the DMA IRQ in a
...
// is work, and wake writers.  Caller must hold uart_ctrl->tx.lock.
static void
...
// Caller must hold uart_ctrl->tx.lock.
static int
