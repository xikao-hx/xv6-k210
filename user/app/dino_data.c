// DinoGame bitmap + font data, extracted verbatim from game/OLED.c.
// 1-bit-per-pixel, SSD1306 page layout (each byte = 8 vertical pixels).
// Generated by Step 0 of the game feature; do not hand-edit the arrays.
